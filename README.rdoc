...
=== Optional:
Create a Review Buddy mapping that will reference the local Github username and @mention a pre-assigned review buddy in Socialcast in the Review Request message.  Specify the mapping by creating a YML file relative to the Repo Root: `config/scgitx_review_buddies.yml` with the following format:
